...
class FFMPEGAnimeDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        for clip_name in clip_names:
            ...
            self.keys.extend([f'{clip_name}/{i:05d}' for i in range(1, num_frames+1)])
    ...
    def get_gt_clip(self, index):
        ...
        if start_frame_idx == 0:
            neighbor_list = list(range(start_frame_idx+1, end_frame_idx + 2, interval))
        else:
            neighbor_list = list(range(start_frame_idx, end_frame_idx + 1, interval))
        ...
        for neighbor in neighbor_list:
            if self.is_lmdb:
                ...
                img_gt_path = osp.join(self.gt_root, clip_name, f'{neighbor:05d}.png')
